require "article_picker"

describe ArticlePicker do
    ...
    describe ".picking" do
        context "given scenario 1" do
            it "returns expected list" do
                ...
                x1 = JSON.parse(scenario1)
                expect(ArticlePicker.round_robin(x1)).to eq([345048])
            end
        end
        ...
        context "given scenario 2" do
            it "returns expected list" do
                ...
                x2 = JSON.parse(scenario2)
                expect(ArticlePicker.round_robin(x2)).to eq([790952, 103678, 788138, 802358])
            end
        end
        ...
        context "given scenario 3" do
            it "returns expected list" do
                ...
                x3 = JSON.parse(scenario3)
                expect(ArticlePicker.round_robin(x3)).to eq([103678, 790952, 802358, 788138])
            end
        end
        ...
        context "given scenario 4" do
            it "returns expected list" do
                ...
                x4 = JSON.parse(scenario4)
                expect(ArticlePicker.round_robin(x4)).to eq([790952, 103678, 802358, 562873])
            end
        end
